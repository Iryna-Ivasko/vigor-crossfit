...
<div class="off-canvas-wrapper">
    <div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
        ...
        <header class="site-header <?= is_front_page() ? 'absolute' : '' ?>">
            <div class="site-header__content">
                <div class="site-title-bar title-bar" data-responsive-toggle="site-navigation" data-hide-for="large">
                    ...
                    <div class="title-bar-right">
                        <button class="menu-icon" type="button"
                                data-toggle="<?= $responsiveToggleId ?>"></button>
                    </div>
                </div>
                ...
                <nav id="site-navigation" class="main-navigation top-bar">
                    ...
                    <div class="top-bar-right">
                        ...
                        <a href="<?= wc_get_cart_url() ?>" class="basket">
                            <img src="<?= get_template_directory_uri() . '/assets/img/cart.svg' ?>"
                                 alt="<?= __('Cart', 'foundationpress') ?>">
